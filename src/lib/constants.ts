...
export const SITE_NAME = "LogerBien";
export const SITE_TAGLINE = "L'immobilier guinéen simplifié";
export const SITE_DESCRIPTION = "LogerBien est la plateforme immobilière de confiance en Guinée. Trouvez rapidement un appartement, une maison ou un studio à Conakry et partout en Guinée.";
export const WHATSAPP_DEFAULT_MESSAGE = "Bonjour, je viens de LogerBien. Je suis intéressé(e) par votre annonce. Est-elle toujours disponible ?";
