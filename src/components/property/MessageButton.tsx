  ...
  return (
    <>
      <button
        ...
        className={
          className ??
          "flex items-center justify-center gap-2 w-full bg-[var(--bg-card)] hover:bg-[#203a24] text-[#ffffff] font-semibold py-3 px-4 rounded-xl transition-colors border border-[var(--border)] text-sm disabled:opacity-60"
        }
      >
        {checking
