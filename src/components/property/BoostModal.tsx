          ...
          <div className="p-5 space-y-5">
            ...
            {isBoosted && remainingDays !== null && (
              <div className="rounded-xl p-3 text-sm font-semibold text-white flex items-center gap-2"
                style={{ backgroundColor: "rgba(212,175,55,0.15)", border: "1px solid rgba(249,115,22,0.4)" }}>
                <Star className="w-4 h-4 flex-shrink-0" style={{ color: "var(--accent-gold)" }} />
              ...
              {BOOST_PLANS.map((plan) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      borderColor: isSelected ? "var(--accent-gold)" : "#2a3040",
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{
                            borderColor: isSelected ? "var(--accent-gold)" : "#475569",
                    ...
                    <p className="text-base font-black ml-6" style={{ color: "var(--accent-gold)" }}>
                      {plan.priceLabel}
                    </p>
                    <ul className="ml-6 mt-2 space-y-1">
                      {plan.advantages.map((adv) => (
                        <li key={adv} className="flex items-center gap-1.5 text-xs" style={{ color: "#94a3b8" }}>
                          <Check className="w-3 h-3 flex-shrink-0" style={{ color: "var(--accent-gold)" }} />
                          {adv}
                        </li>
                      ))}
                    </ul>
                ...
                {PAYMENT_METHODS.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span className="text-sm font-semibold" style={{ color: isSelected ? "var(--accent-gold)" : "#94a3b8" }}>
                        {m.label}
                      </span>
                    </label>
                  );
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                ...
                style={{ backgroundColor: "var(--accent-gold)", color: "var(--text-primary)", opacity: loading ? 0.8 : 1 }}
              >
                {loading ? (
                  <>
