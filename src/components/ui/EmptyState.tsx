  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-6">
      <div className="w-20 h-20 rounded-full bg-[var(--accent-gold)]/10 flex items-center justify-center mb-5">
        <Icon className="w-12 h-12 text-[var(--accent-gold)]" />
      </div>
      ...
      {action && (
        <Link
          href={action.href}
          className="bg-[var(--accent-gold)] hover:bg-[#B8963A] active:bg-[#D96309] text-white font-semibold px-6 py-3 rounded-xl transition-colors"
        >
          {action.label}
        </Link>
      )}
