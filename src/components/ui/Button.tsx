...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "brand", size = "md", loading, className, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      brand: "bg-[#D4AF37] hover:bg-[#B8963A] text-[#0A1216] shadow-[0_4px_20px_rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(249,115,22,0.4)]",
      outline: "border-2 border-[#D4AF37] text-[#D4AF37] hover:bg-[#B8963A] hover:text-white",
