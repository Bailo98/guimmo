...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "brand", size = "md", loading, className, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      brand: "bg-[var(--accent-gold)] hover:bg-[#B8963A] text-[var(--bg-primary)] shadow-[0_4px_20px_rgba(212,175,55,0.25)] hover:shadow-[0_8px_32px_rgba(249,115,22,0.4)]",
      outline: "border-2 border-[var(--accent-gold)] text-[var(--accent-gold)] hover:bg-[#B8963A] hover:text-white",
