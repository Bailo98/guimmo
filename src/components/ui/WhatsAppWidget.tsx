  ...
  return (
    <div className="fixed bottom-24 right-4 z-50 md:bottom-8 group">
      ...
      <div className="absolute bottom-full right-0 mb-2 hidden group-hover:block">
        <div className="bg-slate-900 text-white text-xs font-semibold px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
          Besoin d&apos;aide ?
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative flex w-14 h-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.5)]"
