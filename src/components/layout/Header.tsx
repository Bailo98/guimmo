...
export function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-[1180px] mx-auto px-5 md:px-0 h-[72px] flex items-center justify-between gap-4">
        <Logo />
        ...
        <nav className="hidden md:flex items-center gap-5">
          <Link
            ...
            style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname.startsWith("/annonces") ? "var(--nav-text-active)" : "var(--nav-text)" }}
          >
            Annonces
          </Link>
          <Link
            href="/je-cherche"
            className="px-3 py-2 rounded-xl transition-colors hover:bg-black/5"
            style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname === "/je-cherche" ? "var(--nav-text-active)" : "var(--nav-text)" }}
          >
            Je cherche 🔍
          </Link>
          <Link
            href="/agents"
            className="px-3 py-2 rounded-xl transition-colors hover:bg-black/5"
            style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", color: pathname === "/agents" ? "var(--nav-text-active)" : "var(--nav-text)" }}
          >
            Agents
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            style={{ color: "var(--nav-text-active)", border: "1px solid var(--border)", background: "var(--bg-card)" }}
