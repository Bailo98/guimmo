    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ color: "rgba(240,230,204,0.50)", background: "rgba(240,230,204,0.06)" }}
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <button
          ...
          style={{ border: "1px solid rgba(240,230,204,0.20)", color: "rgba(240,230,204,0.80)", height: 48, fontSize: 14 }}
        >
          J&apos;ai déjà un compte
        </button>
      </div>
