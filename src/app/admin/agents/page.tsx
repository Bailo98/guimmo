    ...
    <div style={{ padding: "28px 24px 40px", maxWidth: 1200 }} className="px-4 md:px-6">
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "nowrap", width: "100%", gap: 16, marginBottom: 16 }}>
        <div style={{ minWidth: 0 }}>
          <h1 style={{ color: TEXT_PRI, fontWeight: 900, fontSize: "clamp(20px,4vw,26px)", margin: 0 }}>Agents LogerBien</h1>
        ...
        <div
          ...
          className="admin-add-btn admin-btn-dark"
          style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 8,
      ...
      {deleteTarget && (
        ...
        >
          <div style={{ background: "var(--bg-card)", border: "1px solid rgba(239,68,68,0.35)", borderRadius: 16, padding: 24, maxWidth: 340, width: "100%" }}
