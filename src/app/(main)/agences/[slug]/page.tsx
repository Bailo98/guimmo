        ...
        <div className="flex items-start gap-5">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap mb-1">
              <h1 className="text-xl font-black" style={{ color: "var(--text-primary)", fontFamily: "var(--font-display), sans-serif" }}>{agencyName}</h1>
            ...
            {profile.website && (
              <a href={profile.website} target="_blank" rel="noopener noreferrer"
                className="text-xs hover:underline mt-1.5 inline-block" style={{ color: "var(--accent-gold)" }}>
                {profile.website}
              </a>
            )}
          </div>
