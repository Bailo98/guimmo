            ...
            {[
              ...
              <div key={f.key}>
                ...
                <input
                  ...
                  className={`w-full bg-[#2c2f36] border border-[#1e2a30] rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none ${f.key === "email" ? "opacity-60 cursor-not-allowed" : "focus:ring-2 focus:ring-[#E9E900]"}`}
                />
                {f.key === "email" && (
