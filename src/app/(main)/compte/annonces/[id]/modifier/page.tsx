  ...
  if (!listing) {
    return (
      <div className="max-w-xl mx-auto px-4 py-10 text-center">
        ...
        <Link href="/compte/annonces" className="text-[#F97316] font-semibold text-sm hover:underline">
    ...
    <div className="max-w-xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link
          ...
          className="w-9 h-9 rounded-xl border border-slate-200 dark:border-[#2a3040] flex items-center justify-center text-slate-600 dark:text-slate-300 hover:border-[#F97316] hover:text-[#F97316] transition-colors"
        >
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              <input
                ...
                className={cn(
                  "w-full bg-slate-50 dark:bg-[#151922] border rounded-xl px-4 py-3 text-slate-900 dark:text-white text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#F97316]",
