    ...
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          { label: "Annonces actives", value: "3", change: "", icon: Home, color: "text-[#D4AF37]", bg: "bg-orange-50 dark:bg-orange-900/20" },
          { label: "Taux de contact", value: "7.1%", change: "+2%", icon: TrendingUp, color: "text-purple-500", bg: "bg-purple-50 dark:bg-purple-900/20" },
        ].map((s) => {
          const Icon = s.icon;
          return (
            <div key={s.label} className="bg-[var(--bg-card-light)] rounded-2xl p-4 border border-[var(--color-border)]">
        ...
        <div className="flex items-end gap-2 h-32">
          {WEEKLY_VIEWS.map((v, i) => (
            <div key={i} className="flex-1 flex flex-col items-center gap-1">
              ...
              <div className="w-full bg-[#D4AF37] rounded-t-lg transition-all" style={{ height: `${(v / maxViews) * 96}px` }} />
      ...
      <div className="bg-[var(--bg-card-light)] rounded-2xl p-5 border border-[var(--color-border)]">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <Zap className="w-4 h-4 text-[#D4AF37]" /> Performances du boost
          </h2>
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-xs font-bold text-[#D4AF37]">{AFTER_VIEWS} vues/jour</span>
            </div>
            <div className="h-3 bg-slate-100 dark:bg-[#151922] rounded-full overflow-hidden">
              <div
        ...
        <button
          ...
          className="mt-5 w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#D4AF37] text-white font-bold text-sm hover:bg-[#B8963A] transition-colors"
        >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[var(--bg-card-light)] border border-[var(--color-border)] rounded-xl px-3 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#D4AF37]"
                >
