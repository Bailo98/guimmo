...
export default async function PropertyDetailPage({ params }: Props) {
  ...
  return (
    <div className="bg-[#0F0F0F] pb-32 md:pb-12">
      ...
      <div className="lg:hidden fixed bottom-16 left-0 right-0 z-40 px-4 py-3 space-y-2" style={{ background: "rgba(15,15,15,0.97)", backdropFilter: "blur(20px) saturate(180%)", WebkitBackdropFilter: "blur(20px) saturate(180%)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
