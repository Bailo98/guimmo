            ...
            <div className="hidden lg:block lg:col-span-1">
              <div className="sticky top-20 rounded-2xl p-5 space-y-3" style={{ background: "#111a1f", border: "1px solid #1e2a30" }}>
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#c4c400] active:scale-95 text-white font-bold py-4 px-4 rounded-2xl transition-all shadow-[0_8px_32px_rgba(37,211,102,0.3)]">
