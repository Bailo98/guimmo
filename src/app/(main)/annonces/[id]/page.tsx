...
import { ArrowLeft, MapPin, Bed, Bath, Square, Phone, CheckCircle, XCircle, MessageCircle } from "lucide-react";
            ...
            <div className="hidden lg:block lg:col-span-1">
              <div className="sticky top-20 rounded-2xl p-5 space-y-3" style={{ background: "#111a1f", border: "1px solid #1e2a30" }}>
                ...
                {isOwner ? (
                  ...
                  /* ── 3 boutons ronds ── */
                  <div style={{ display: "flex", justifyContent: "center", gap: 28, padding: "20px 0 8px" }}>
                    {/* Appeler */}
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                      ...
                      <span style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary-new)" }}>Appeler</span>
                    </div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                      ...
                      <span style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary-new)" }}>WhatsApp</span>
                    </div>

                    {/* Localiser */}
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                      <a href="#property-map" style={{
                        width: 64, height: 64, borderRadius: "50%",
                      ...
                      <span style={{ fontSize: 13, fontWeight: 600, color: "var(--text-secondary-new)" }}>Localiser</span>
                    </div>
                  </div>
                )}
        ...
        {isOwner ? (
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 28, padding: "8px 0" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.65)" }}>Appeler</span>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.65)" }}>WhatsApp</span>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(255,255,255,0.65)" }}>Localiser</span>
            </div>
          </div>
        )}
      </div>
