      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        {properties.length > 0 ? (
          <>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">
                ...
                <span className="text-[#D4AF37]">{neighborhood.name}</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <Link
              href="/annonces"
              className="inline-flex items-center gap-2 bg-[#D4AF37] hover:bg-[#B8963A] text-white font-semibold px-6 py-3 rounded-xl transition-colors"
            >
              <ArrowLeft className="w-4 h-4" />
        ...
        {properties.length > 0 && (
          <div className="mt-10 text-center">
            <Link
              href="/annonces"
              className="inline-flex items-center gap-2 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-[#D4AF37] hover:text-[#D4AF37] font-semibold px-6 py-3 rounded-xl transition-colors"
            >
              <ArrowLeft className="w-4 h-4" />
              Voir toutes les annonces
            </Link>
