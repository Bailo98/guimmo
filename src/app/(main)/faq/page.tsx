...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "BienLoger demande-t-il un paiement ?",
        a: "Non. BienLoger ne perçoit jamais d'argent entre locataires et propriétaires. Méfiez-vous de toute demande de paiement avant visite.",
      },
    ],
  },
  {
  ...
  return (
    <div className="border-b border-slate-100 dark:border-[#2a3040] last:border-0">
      ...
      >
        ...
        <ChevronDown
          className={cn(
            "w-5 h-5 flex-shrink-0 text-[#F97316] transition-transform duration-200",
            isOpen && "rotate-180"
          )}
        />
      </button>
      ...
      <div className="bg-gradient-to-br from-[#F97316] via-[#ea6c0a] to-[#c2540a] text-white">
        <div className="max-w-3xl mx-auto px-4 py-16 md:py-20 text-center">
          ...
          <p className="text-white/80 text-lg mb-8">
            Trouvez rapidement la réponse à vos questions sur BienLoger.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        {filtered.length === 0 ? (
          <div className="text-center py-16">
            ...
            <button
              onClick={() => setSearch("")}
              className="mt-4 text-[#F97316] text-sm font-semibold hover:underline"
            >
