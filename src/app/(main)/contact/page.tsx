    ...
    <div className="max-w-4xl mx-auto px-4 py-10 pb-24">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-[#1e2430] rounded-2xl p-5 border border-slate-100 dark:border-[#2a3040] flex items-start gap-4">
              ...
              {[
                ...
                <div key={f.key}>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-[#151922] border border-slate-200 dark:border-[#2a3040] rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#009460] placeholder:text-slate-400"
                  />
                </div>
              ))}
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 dark:bg-[#151922] border border-slate-200 dark:border-[#2a3040] rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#009460] placeholder:text-slate-400 resize-none"
                />
              </div>
              <button
                type="submit"
