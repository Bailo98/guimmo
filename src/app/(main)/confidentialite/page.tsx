...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité de BienLoger — comment nous protégeons vos données.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 pb-24">
      ...
      <div className="space-y-8 text-slate-600 dark:text-slate-300 leading-relaxed">
        <section>
          ...
          <p>BienLoger collecte uniquement les données nécessaires au bon fonctionnement de la plateforme :</p>
        ...
        <section>
          ...
          <p className="text-sm">BienLoger ne vend jamais vos données personnelles à des tiers. Vos informations de contact (numéro WhatsApp) ne sont partagées qu'avec les utilisateurs que vous choisissez de contacter directement via la plateforme.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm">Conformément aux lois en vigueur, vous disposez d'un droit d'accès, de rectification et de suppression de vos données. Pour exercer ces droits, contactez-nous à <a href="mailto:contact@BienLoger.gn" className="text-[#009460] hover:underline">contact@BienLoger.gn</a>.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm">Pour toute question relative à cette politique, écrivez-nous à <a href="mailto:contact@BienLoger.gn" className="text-[#009460] hover:underline">contact@BienLoger.gn</a> ou via notre <Link href="/contact" className="text-[#009460] hover:underline">page de contact</Link>.</p>
        </section>
      </div>
    </div>
  );
