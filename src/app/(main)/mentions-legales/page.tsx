...
export const metadata: Metadata = {
  ...
  description: "Mentions légales de LogerBien — informations légales sur l'éditeur et l'hébergeur.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 pb-24">
      ...
      <div className="space-y-8 text-slate-600 dark:text-slate-300 leading-relaxed">
        <section>
          ...
          <div className="bg-[var(--bg-card-light)] rounded-2xl p-5 border border-[var(--border)] text-sm space-y-1">
            ...
            <p><span className="font-semibold text-slate-900 dark:text-white">Email :</span> <a href="mailto:contact@LogerBien.gn" className="text-[#009460] hover:underline">contact@LogerBien.gn</a></p>
        ...
        <section>
          ...
          <p className="text-sm">L'ensemble des éléments constituant la plateforme LogerBien (textes, logos, images, structure) est protégé par le droit de la propriété intellectuelle. Toute reproduction, totale ou partielle, sans autorisation préalable écrite est interdite.</p>
        </section>

        <section>
          <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">Responsabilité</h2>
          <p className="text-sm">LogerBien est une plateforme de mise en relation entre propriétaires et locataires. Les annonces publiées relèvent de la seule responsabilité de leurs auteurs. LogerBien met en œuvre tous les moyens raisonnables pour vérifier la conformité des annonces, sans pouvoir garantir l'exhaustivité de cette vérification.</p>
        </section>
