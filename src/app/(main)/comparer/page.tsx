            ...
            <tr>
              ...
              {properties.map((p) => p && (
                <th key={p.id} className="pb-4 px-3 align-top">
                  <div className="bg-[var(--bg-card-light)] rounded-2xl overflow-hidden border border-[var(--border)]">
                    {/* Image */}
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex gap-1 mt-2">
                        <button
                          ...
                          className="flex-1 text-xs py-1.5 rounded-lg border border-[var(--border)] text-slate-500 hover:text-red-500 hover:border-red-500 transition-colors flex items-center justify-center gap-1"
                        >
