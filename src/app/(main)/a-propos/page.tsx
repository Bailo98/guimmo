  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 pb-24">
      ...
      <div className="flex justify-center mb-14">
        <div className="bg-white dark:bg-[#1e2430] rounded-2xl p-6 border border-slate-100 dark:border-[#2a3040] text-center w-48">
          ...
          <p className="font-bold text-slate-900 dark:text-white text-sm">Diallo Baïlo</p>
          <p className="text-slate-400 text-xs mt-0.5">Fondateur &amp; CEO</p>
        </div>
      </div>
