  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-14">
        {VALUES.map((v) => (
          <div key={v.title} className="rounded-2xl p-5 flex gap-4" style={{ background: "var(--border-subtle)", backdropFilter: "blur(20px) saturate(180%)", WebkitBackdropFilter: "blur(20px) saturate(180%)", border: "1px solid rgba(255,255,255,0.10)" }}>
      ...
      <div className="flex justify-center mb-14">
        <div className="rounded-2xl p-6 text-center w-48" style={{ background: "var(--border-subtle)", backdropFilter: "blur(20px) saturate(180%)", WebkitBackdropFilter: "blur(20px) saturate(180%)", border: "1px solid rgba(255,255,255,0.10)" }}>
