    ...
    <div className="max-w-5xl mx-auto px-4 pb-16 pt-4">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <div className="mt-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-bold text-[#F97316]">{owner.trustScore}%</span>
              </div>
              <div className="w-full max-w-xs bg-slate-100 dark:bg-[#151922] rounded-full h-2">
                <div
                  className="h-2 rounded-full"
                  style={{ width: `${owner.trustScore}%`, background: "linear-gradient(90deg, #F97316, #EA6C0A)" }}
                />
              </div>
            </div>
            ...
            {/* Response rate */}
            {owner.responseRate && (
              <p className="text-green-500 dark:text-green-400 text-sm font-medium mt-2">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          >
            <p className="text-2xl font-black text-[#F97316]">{stat.value}</p>
