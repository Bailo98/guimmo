...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${owner.name} — LogerBien`,
    description: `Profil de ${owner.name} sur LogerBien. Découvrez ses annonces immobilières en Guinée.`,
  };
}
...
export default async function ProprietaireProfilePage({ params }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 pb-16 pt-4">
      ...
      {/* Profile Header */}
      <div className="bg-[var(--bg-card-light)] rounded-2xl p-6 border border-[var(--border)] mb-6">
        ...
        {owner.badges.length > 0 && (
          <div className="mt-5 pt-5 border-t border-slate-100 dark:border-[var(--border)]">
