    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0f1117]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8 flex-wrap">
          <Link href="/" className="flex items-center gap-1 hover:text-[#E9E900] transition-colors">
            <Home className="w-3.5 h-3.5" />
            Accueil
          </Link>
          <ChevronRight className="w-3.5 h-3.5 text-slate-300" />
          <Link href="/blog" className="hover:text-[#E9E900] transition-colors">
            Blog
          </Link>
          <ChevronRight className="w-3.5 h-3.5 text-slate-300" />
        ...
        <div className="lg:grid lg:grid-cols-[1fr_320px] lg:gap-10">
          ...
          <article>
            ...
            <header className="mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
                ...
                <span className="flex items-center gap-1.5 bg-[#E9E900]/10 text-[#E9E900] font-semibold px-2.5 py-0.5 rounded-full">
            ...
            {/* Bottom CTA */}
            <div className="mt-10 p-6 bg-gradient-to-br from-[#E9E900]/10 to-[#c4c400]/5 border border-[#E9E900]/20 rounded-2xl">
              ...
              <Link
                href="/annonces"
                className="inline-flex items-center gap-2 bg-[#E9E900] hover:bg-[#c4c400] text-white font-bold px-5 py-2.5 rounded-xl transition-colors text-sm"
              >
                Voir les annonces
          ...
          <aside className="mt-10 lg:mt-0">
            <div className="lg:sticky lg:top-6 space-y-6">
                  ...
                  {recentArticles.map((a) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-slate-800 dark:text-white line-clamp-2 group-hover:text-[#E9E900] transition-colors">
                          {a.title}
                        </p>
              ...
              {/* Newsletter teaser */}
              <div className="bg-gradient-to-br from-[#E9E900] to-[#c4c400] rounded-2xl p-5 text-white">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-white text-[#E9E900] font-bold px-4 py-2 rounded-xl text-sm hover:bg-white/90 transition-colors"
                >
                  Rejoindre
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {fallbackRelated.map((a) => (
              <Link
                key={a.slug}
                href={`/blog/${a.slug}`}
                className="group bg-white dark:bg-[#1e2430] rounded-2xl overflow-hidden border border-slate-100 dark:border-[#2a3040] hover:shadow-lg transition-shadow flex gap-4"
              >
                ...
                <div className="p-4 flex flex-col justify-center min-w-0">
                  ...
                  <h3 className="font-bold text-slate-900 dark:text-white text-sm leading-snug group-hover:text-[#E9E900] transition-colors line-clamp-2">
                    {a.title}
                  </h3>
