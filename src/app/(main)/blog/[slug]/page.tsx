          ...
          <article>
            ...
            <header className="mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
                ...
                <span className="flex items-center gap-1.5 bg-[#F97316]/10 text-[#F97316] font-semibold px-2.5 py-0.5 rounded-full">
            ...
            {/* Bottom CTA */}
            <div className="mt-10 p-6 bg-gradient-to-br from-[#F97316]/10 to-[#ea6c0a]/5 border border-[#F97316]/20 rounded-2xl">
              ...
              <Link
                href="/annonces"
                className="inline-flex items-center gap-2 bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-5 py-2.5 rounded-xl transition-colors text-sm"
              >
                Voir les annonces
                  ...
                  {recentArticles.map((a) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-slate-800 dark:text-white line-clamp-2 group-hover:text-[#F97316] transition-colors">
                          {a.title}
                        </p>
            ...
            {fallbackRelated.map((a) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col justify-center min-w-0">
                  ...
                  <h3 className="font-bold text-slate-900 dark:text-white text-sm leading-snug group-hover:text-[#F97316] transition-colors line-clamp-2">
                    {a.title}
                  </h3>
