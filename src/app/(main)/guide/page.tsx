          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {popularNeighborhoods.map((n) => (
              <Link
                ...
                className="group flex flex-col items-center gap-2 p-3 rounded-2xl bg-[var(--bg-card-light)] border border-[var(--border)] hover:border-[#D4AF37] hover:bg-[#B8963A]/5 transition-all text-center"
              >
