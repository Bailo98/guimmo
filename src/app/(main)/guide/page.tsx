          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {popularNeighborhoods.map((n) => (
              <Link
                ...
                className="group flex flex-col items-center gap-2 p-3 rounded-2xl bg-slate-50 dark:bg-[#151922] border border-slate-100 dark:border-[#2a3040] hover:border-[#E9E900] hover:bg-[#c4c400]/5 transition-all text-center"
              >
