...
const STEPS_SEARCH = [
  ...
  { n: 2, icon: Shield, title: "Vérifiez la fiabilité", desc: "Regardez les badges LogerBien Safe : annonce vérifiée, propriétaire vérifié, photos réelles." },
  ...
  { n: 4, icon: Home, title: "Visitez et signez", desc: "Visitez le logement, négociez le prix, signez le contrat. LogerBien vous a mis en relation." },
];
    ...
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-16">
      <div className="text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-3 max-w-xl mx-auto">
          LogerBien connecte directement locataires et propriétaires en Guinée. Simple, rapide, sans intermédiaire.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {STEPS_SEARCH.map((s) => {
            const Icon = s.icon;
            return (
              <div key={s.n} className="bg-[var(--bg-card-light)] rounded-2xl p-5 border border-[var(--color-border)] flex gap-4">
