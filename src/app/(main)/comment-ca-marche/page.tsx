    ...
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-16">
      ...
      <div>
            ...
            return (
              <div key={s.n} className="bg-white dark:bg-[#1e2430] rounded-2xl p-5 border border-slate-100 dark:border-[#2a3040] flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 bg-[#F97316] rounded-2xl flex items-center justify-center text-white font-black">{s.n}</div>
                </div>
                <div>
        ...
        <div className="mt-6 text-center">
          <Link href="/annonces" className="inline-flex items-center gap-2 bg-[#F97316] text-white font-bold px-8 py-3.5 rounded-2xl hover:bg-[#EA6C0A] transition-colors">
      ...
      {/* Guide link */}
      <div className="text-center">
        <Link href="/guide" className="inline-flex items-center gap-2 text-[#F97316] font-semibold hover:underline">
