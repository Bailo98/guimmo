            ...
            {step === 1 && (
              <>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-white hover:bg-slate-100 text-slate-800 font-semibold py-3 rounded-xl border border-slate-200 transition-colors text-sm mb-4"
                >
                ...
                <div className="relative mb-4">
                  ...
                  <div className="relative flex justify-center text-xs text-slate-500 bg-[#1e2430] px-3">ou avec téléphone</div>
                </div>
