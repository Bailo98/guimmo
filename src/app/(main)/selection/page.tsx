  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[var(--bg-primary)]">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-[#1e1008] text-white">
        {/* Decorative orb */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#D4AF37]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#D4AF37]/10 rounded-full blur-2xl translate-y-1/2 -translate-x-1/4 pointer-events-none" />
        ...
        {boosted.length > 0 && (
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="flex items-center gap-2 bg-[#D4AF37] text-white px-4 py-2 rounded-full font-bold text-sm">
            ...
            <div className="relative mb-2">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#D4AF37]/10 to-transparent pointer-events-none" />
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {boosted.map((property, index) => (
                  <div key={property.id} className="relative">
                    {/* Editorial badge */}
                    <div className="absolute -top-2.5 left-4 z-10">
                      <span className="inline-flex items-center gap-1 bg-[#D4AF37] text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-lg">
