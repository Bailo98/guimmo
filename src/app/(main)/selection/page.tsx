  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[var(--bg-primary)]">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-[#1e1008] text-white">
        {/* Decorative orb */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[var(--accent-gold)]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[var(--accent-gold)]/10 rounded-full blur-2xl translate-y-1/2 -translate-x-1/4 pointer-events-none" />

        <div className="relative max-w-6xl mx-auto px-4 py-14 md:py-20">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-[var(--accent-gold)]/20 border border-[var(--accent-gold)]/30 flex items-center justify-center">
              <Award className="w-5 h-5 text-[var(--accent-gold)]" />
            </div>
            <span className="text-[var(--accent-gold)] font-semibold text-sm uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="flex items-start gap-3 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              <div className="w-8 h-8 rounded-lg bg-[var(--accent-gold)]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        {boosted.length > 0 && (
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="flex items-center gap-2 bg-[var(--accent-gold)] text-white px-4 py-2 rounded-full font-bold text-sm">
            ...
            <div className="relative mb-2">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[var(--accent-gold)]/10 to-transparent pointer-events-none" />
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {boosted.map((property, index) => (
                  <div key={property.id} className="relative">
                    {/* Editorial badge */}
                    <div className="absolute -top-2.5 left-4 z-10">
                      <span className="inline-flex items-center gap-1 bg-[var(--accent-gold)] text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-lg">
        ...
        {sorted.length > 0 && (
          <div className="mt-12 bg-[var(--bg-card-light)] border border-[var(--border)] rounded-2xl p-6 text-center">
